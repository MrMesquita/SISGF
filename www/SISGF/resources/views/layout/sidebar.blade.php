    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                <div class="nav-item">
                    <a href="/"><i class="ik ik-users"></i><span>Farmacêuticos</span></a>
                </div>
                <div class="nav-item">
                    <a href="/"><i class="ik ik-clipboard"></i><span>Atestados</span></a>
                </div>
                <div class="nav-item">
                    <a href="/"><i class="ik ik-users"></i><span>Relatórios</span></a>
                </div>
