            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Funcionários</h5>
                            <span>Listando todos os funcionários do sistema</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12">
                ...
                <div class="card"style="padding: 0 2%">
                    <div class="card-header">
                        <a href="{{url("/funcionarios/register")}}"><button type="button" class="btn btn-success">Novo +</button></a>
                    </div>
                    <div class="card-body" >
                        <table id="data_table" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$drogarias->find($funcionario->drogaria_id)->nome}}</td>
                                    <td>
                                        <div class="table-actions">
                                            <a href="{{url("/funcionarios/$funcionario->id")}}" class=" btn btn-icon btn-secondary text-white"><i class="ik ik-eye"></i></a>
                                            <a href="{{url("/funcionarios/edit/$funcionario->id")}}" class="btn btn-icon btn-primary text-white"><i class="ik ik-edit-2"></i></a>
                                            <button type="button" class="btn btn-danger btn-icon text-white" data-toggle="modal" data-target="#deleteModal-{{$funcionario->id}}"><i class="ik ik-trash-2"></i></button>
                                        </div>
                                    </td>
